...
def mongodb_exception_wrapper(method):
    """Convert pymongo exceptions to generic exception types defined in clearing.database.
...
class MongoDB(AbstractDB):
    ...
    .. seealso:: :class:`clearing.database.AbstractDB` for more on attributes.
    """
